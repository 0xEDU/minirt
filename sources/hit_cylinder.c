...
/*   Updated: 2023/04/12 16:36:03 by guribeir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// int hit_caps(t_cylinder cyl, t_ray *ray, t_variation t, t_hit_record *rec) {
...
//     if (t_bottom >= t.min && t_bottom <= t.max && bottom_radius <= cyl.radius) {
//         rec->t = t_bottom;
//         rec->point = point_bottom;
//         rec->normal = cyl.axis;
//         set_face_normal(rec, ray, &rec->normal);
//         return 1;
//     } else if (t_top >= t.min && t_top <= t.max && top_radius <= cyl.radius) {
//         rec->t = t_top;
//         rec->point = point_top;
//         rec->normal = cyl.axis;
//         set_face_normal(rec, ray, &rec->normal);
